...
- [x] 03-02-PLAN.md — Rename _connect_vcenter to _connect_esxi, remove datacenter/cluster branches, update field refs and comments
...
Plans:
- [x] 04-01-PLAN.md — Update README.md: ESXi-only description, esxi_* config YAML, ESXI_* env vars table, ovftool note for clone_vm
- [x] 04-02-PLAN.md — Replace config.yaml.sample: esxi_host/esxi_user/esxi_password YAML keys, remove datacenter/cluster fields
- [x] 04-03-PLAN.md — Update docker-entrypoint.sh: ESXI_* env var names throughout, remove datacenter/cluster conditionals
- [x] 04-04-PLAN.md — Update CLAUDE.md: 30 tools (not 31), ESXi-only description, ESXI_* config keys, connects to ESXi
